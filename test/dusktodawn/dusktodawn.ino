...
void setup() {
   ...
   *  coordinates.
   *  56.05059677695904, 12.6940192684358
   */
  Dusk2Dawn losAngeles(56.0505, 12.69401, 1);
   ...
   */
  int laSunrise  = losAngeles.sunrise(2021, 04, 10, true);
  int laSunset   = losAngeles.sunset(2021, 04, 10, true);
