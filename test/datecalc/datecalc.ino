...
/*
   ...
   */
    DateTime dt6 (2009, 12, 27, 0, 0, 30);
    showDate("dt6", dt6);

    DateTime dt95 = dt6 + TimeSpan(0, 0, 1, 0); // One week later with TimeSpan addition.
    showDate("dt9.5", dt95);
    dt95 = dt95 + TimeSpan(0, 0, 1, 0); // One week later with TimeSpan addition.
    showDate("dt95", dt95);
